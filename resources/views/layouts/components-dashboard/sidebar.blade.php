<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme shadow-sm">
    <div class="app-brand demo" style="height: 80px;">
        <a href="{{ route('dashboard.index') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2" style="text-transform: uppercase; letter-spacing: 1px;">Tracking<span class="text-primary">KU</span></span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Catatan Kas</span>
        </li>
        <li class="menu-item {{ request()->is('*transaksi*') ? 'active' : '' }}">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
                <div data-i18n="History">Riwayat Transaksi</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
                <i class="menu-icon tf-icons bx bx-bar-chart-square"></i>
                <div data-i18n="Reports">Laporan Keuangan</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ request()->routeIs('dashboard.kategori.*') ? 'active' : '' }}">
            <a href="{{ route('dashboard.kategori.index') }}" class="menu-link">
                ...
                <div data-i18n="Category">Kategori Transaksi</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="#" class="menu-link">
                ...
                <div data-i18n="Accounts">Rekening & Dompet</div>
            </a>
        </li>
